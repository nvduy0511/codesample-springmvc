...
<head>
    ...
    <title>Xóa test case</title>
</head>
<body id="body">
<div id="bodys">
    <div class="table">
        <div class="input">
            <form action="<c:url value="/admin/deleteTestCase/${testcase.id}"/>", method="post">
                <div class="tab">
                    <div style="text-align:left" class="tab_content">
                        <p style="text-align: center; font-weight: 700;">Xóa Test Case</p>
