...
<head>
    ...
    <title>Xóa bài tập code</title>
</head>
<body id="body">
<div id="bodys">
    <div class="table">
        <div class="input">
            <form action="<c:url value="/admin/deleteBTCode/${ex.id}"/>", method="post">
                <div class="tab">
                    <div style="text-align:left" class="tab_content">
                        <p style="text-align: center; font-weight: 700;">Xóa Bài tập code</p>
                        <p>Mã bài tập: ${ex.id}</p>
                        <p>Tiêu đề: ${ex.title}</p>
                        <p>Độ khó: ${ex.level}</p>
                        <p>Tag: ${ex.tag}</p>
