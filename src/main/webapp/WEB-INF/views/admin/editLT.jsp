...
<div id="bodys">
    <div class="edit">
        <form action="<c:url value="/admin/editLT/${Theory.id}"/>" method="post">
            <div class="ckedit">
                <div class="ckedit_child">
                    <p style="text-align: center; font-weight: 700; font-size: 25px;">Sửa bài lý thuyết</p>
                    <div class="input_ckedit">
                        <p style="text-align:left">Id môn học: ${Theory.subject.id}</p>
                        <p>Tiêu đề: <input name="title" class="input_BTCode" value="${Theory.title}"/></p>
                    </div>
